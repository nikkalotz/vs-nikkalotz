...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (isStoryMode)
		{
			detailsText = "Story Mode: Vs Nikk";
		}
		else
		{
		...
		timeTxt.setFormat(Paths.font("pixel.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		comboTxt = new FlxText(400, timeBarBG.y + 60, FlxG.width - 800, "", 32);
		comboTxt.setFormat(Paths.font("int.ttf"), 42, 0xFFFFFFFF, CENTER, FlxTextBorderStyle.OUTLINE, 0xFF000000);
		comboTxt.scrollFactor.set();
		comboTxt.borderSize = 1.25;
		comboTxt.visible = !ClientPrefs.hideHud;
		add(comboTxt);
		if(ClientPrefs.downScroll) {
			comboTxt.y = timeBarBG.y - 208;
		}

		botplayTxt = new FlxText(400, timeBarBG.y + 555, FlxG.width - 800, "HELLO THE GAME IS ON BOTPLAY!!!", 32);
	...
	{
		scoreTxt.text = ('Score: ' + songScore + ' - Misses: ' + songMisses + ' - Accuracy: ' + ratingName + ' - Misses: ' + songMisses);
	...
	public var comboTxtTweenAlpha:FlxTween;
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		comboTxt.text = (daRating.name.toUpperCase() + "\n" + "x" + combo);
		...
		comboTxtTween = FlxTween.tween(comboTxt.scale, {x: 1, y: 1}, 0.7, {
		...
		if(comboTxtTweenAlpha != null) {
			comboTxtTweenAlpha.cancel();
		}

		comboTxt.alpha = 1;

		comboTxtTweenAlpha = FlxTween.tween(comboTxt, {alpha: 0}, 0.9, {ease: FlxEase.quadInOut, onComplete: function(twn:FlxTween) {comboTxtTweenAlpha = null;}});
