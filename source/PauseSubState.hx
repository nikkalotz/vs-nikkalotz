...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		blueballedTxt.text = "Died " + PlayState.deathCounter + " times";
		blueballedTxt.scrollFactor.set();
		blueballedTxt.setFormat(Paths.font('vcr.ttf'), 32);
		blueballedTxt.updateHitbox();
		add(blueballedTxt);

		practiceText = new FlxText(20, 15 + 70, 0, "PRACTICE MODE", 32);
		...
		var chartingText:FlxText = new FlxText(20, 15 + 70, 0, "CHARTING MODE", 32);
